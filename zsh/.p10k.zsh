# Generated by Powerlevel10k configuration wizard on 2020-09-07 at 14:46 +08.
...
# 24h time, 2 lines, disconnected, right frame, black-ornaments, compact, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='bond0'
  # Custom icon.
